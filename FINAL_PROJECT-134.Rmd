...
laptop$latest_price <- laptop$latest_price/81.41
```
...
Looking at the plot we can see that there is a 20% correlation between the price of the laptop and the display size. 
