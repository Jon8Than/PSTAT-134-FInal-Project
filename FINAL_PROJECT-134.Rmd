...
ec_trainbc <- training(ec_splitbc)
dim(ec_trainbc) #331 obs. 18 columns
ec_testbc <- testing(ec_splitbc)
dim(ec_testbc) #84 obs. 18 columns
```
...
```RSQ``` : mean = 0.757 & standard error = 0.0127
...
```RSQ``` : mean = 0.756 & standard error = 0.0129
...
```RSQ``` : mean = 0.872 & standard error = 0.00966
...
```RSQ``` : mean = 0.790 & standard error = 0.0153
